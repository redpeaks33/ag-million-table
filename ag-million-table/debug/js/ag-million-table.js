angular.module('ag-million-table', [])
    .constant('mdtConfig', {
        list: {
            original: [],
            display: [],
    ...
    .directive("agMillionTable", ['$filter', 'JSONCreationService', 'vsscrollbarEvent',
        function ($filter, JSONCreationService, vsscrollbarEvent) {
            return {
                restrict: 'EA',
                replace: true,
                scope: false,
                templateUrl: 'debug/html/ag-million-table.html',
    ...
    .directive('mildTableTh', ['mdtConfig', '$rootScope', 'vsscrollbarEvent', function (mdtConfig, $rootScope, vsscrollbarEvent) {
        return {
            restrict: 'EA',
            //require: '^div',
            scope: {
            ...
            templateUrl: 'debug/html/ag-column-filter.html',
            compile: function (element, attr) {
                //#region column size
                ...
                return function (scope, element, attr, tableFilterCtrl) {
                    ...
                    //#region initialize
                    function initialize() {
                        if (scope.enablefilter == undefined) {
                            scope.enablefilter = true;
                        }

                        if (!scope.enablefilter || !scope.$parent.allItems) return;
